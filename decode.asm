...
int main(int argc,char* argv[]){
  ...
  59:	0f 85 3c 01 00 00    	jne    19b <main+0x19b>
    if(argc <2){
  5f:	83 ef 01             	sub    $0x1,%edi
    char* text_to_encode[argc-1];
  62:	89 e6                	mov    %esp,%esi
    if(argc <2){
  64:	0f 8e 1c 01 00 00    	jle    186 <main+0x186>
  ...
  91:	6a 01                	push   $0x1
  93:	e8 18 05 00 00       	call   5b0 <printf>
    for (int i=0;i<argc-1;i++){
  98:	83 c4 10             	add    $0x10,%esp
  9b:	85 db                	test   %ebx,%ebx
  9d:	0f 8e b6 00 00 00    	jle    159 <main+0x159>
  ...
  b0:	83 c7 01             	add    $0x1,%edi
        cesar_encode(text_to_encode[i],15);
  b3:	e8 f8 00 00 00       	call   1b0 <cesar_encode>
    for (int i=0;i<argc-1;i++){
  ...
  c7:	68 13 09 00 00       	push   $0x913
  cc:	e8 c2 03 00 00       	call   493 <open>
  ...
  d8:	0f 88 95 00 00 00    	js     173 <main+0x173>
  de:	89 75 e0             	mov    %esi,-0x20(%ebp)
  e1:	31 d2                	xor    %edx,%edx
  e3:	89 5d e4             	mov    %ebx,-0x1c(%ebp)
  ...
  f9:	83 c3 01             	add    $0x1,%ebx
                write(fd,text_to_encode[i],strlen(text_to_encode[i]));
  fc:	56                   	push   %esi
  fd:	e8 8e 01 00 00       	call   290 <strlen>
 102:	83 c4 0c             	add    $0xc,%esp
 105:	50                   	push   %eax
 106:	56                   	push   %esi
 107:	57                   	push   %edi
 108:	e8 66 03 00 00       	call   473 <write>
                write(fd,space,strlen(space));
 10d:	c7 04 24 0f 09 00 00 	movl   $0x90f,(%esp)
 114:	e8 77 01 00 00       	call   290 <strlen>
 119:	83 c4 0c             	add    $0xc,%esp
 11c:	50                   	push   %eax
 11d:	68 0f 09 00 00       	push   $0x90f
 122:	57                   	push   %edi
 123:	e8 4b 03 00 00       	call   473 <write>
            for (int i=0;i<argc-1;i++){
 ...
 138:	e8 53 01 00 00       	call   290 <strlen>
 13d:	83 c4 0c             	add    $0xc,%esp
 140:	50                   	push   %eax
 141:	68 11 09 00 00       	push   $0x911
 146:	57                   	push   %edi
 147:	e8 27 03 00 00       	call   473 <write>


        }
        close(fd);
 14c:	89 3c 24             	mov    %edi,(%esp)
 14f:	e8 27 03 00 00       	call   47b <close>
    exit();
 154:	e8 fa 02 00 00       	call   453 <exit>
        int fd=open("result.txt",O_CREATE|O_RDWR);
 159:	50                   	push   %eax
 15a:	50                   	push   %eax
 15b:	68 02 02 00 00       	push   $0x202
 160:	68 13 09 00 00       	push   $0x913
 165:	e8 29 03 00 00       	call   493 <open>
        if (fd <0){
 ...
 171:	79 bd                	jns    130 <main+0x130>
            printf(1,"Unable to open or create file");
 173:	52                   	push   %edx
 174:	52                   	push   %edx
 175:	68 f1 08 00 00       	push   $0x8f1
 17a:	6a 01                	push   $0x1
 17c:	e8 2f 04 00 00       	call   5b0 <printf>
            exit();
 181:	e8 cd 02 00 00       	call   453 <exit>
        printf(1,"no text to encode passed");
 186:	51                   	push   %ecx
 187:	51                   	push   %ecx
 188:	68 d8 08 00 00       	push   $0x8d8
 18d:	6a 01                	push   $0x1
 18f:	e8 1c 04 00 00       	call   5b0 <printf>
 194:	89 f4                	mov    %esi,%esp
 196:	e9 ec fe ff ff       	jmp    87 <main+0x87>
    char* text_to_encode[argc-1];
 19b:	83 4c 04 fc 00       	orl    $0x0,-0x4(%esp,%eax,1)
 1a0:	e9 ba fe ff ff       	jmp    5f <main+0x5f>
...
void cesar_encode(char* text,int shift){
 ...
 1b4:	8b 55 08             	mov    0x8(%ebp),%edx
        text[i]=(c-shift);
 1b7:	0f b6 7d 0c          	movzbl 0xc(%ebp),%edi
void cesar_encode(char* text,int shift){
 1bb:	56                   	push   %esi
 1bc:	53                   	push   %ebx
    for (int i=0;text[i]!='\0';i++)
 1bd:	0f b6 02             	movzbl (%edx),%eax
 1c0:	84 c0                	test   %al,%al
 1c2:	74 37                	je     1fb <cesar_encode+0x4b>
 1c4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        text[i]=(c-shift);
 1c8:	89 fb                	mov    %edi,%ebx
 1ca:	89 c1                	mov    %eax,%ecx
        if(  c>='a' && c<='z' && text[i]<'a')
 1cc:	8d 70 9f             	lea    -0x61(%eax),%esi
        text[i]=(c-shift);
 1cf:	29 d9                	sub    %ebx,%ecx
        if(  c>='a' && c<='z' && text[i]<'a')
 1d1:	89 f3                	mov    %esi,%ebx
        text[i]=(c-shift);
 1d3:	88 0a                	mov    %cl,(%edx)
        if(  c>='a' && c<='z' && text[i]<'a')
 1d5:	80 fb 19             	cmp    $0x19,%bl
 1d8:	77 05                	ja     1df <cesar_encode+0x2f>
 1da:	80 f9 60             	cmp    $0x60,%cl
 1dd:	7e 0c                	jle    1eb <cesar_encode+0x3b>
         if( c<='Z' && c>='A' && text[i]<'A')
 1df:	83 e8 41             	sub    $0x41,%eax
 1e2:	3c 19                	cmp    $0x19,%al
 1e4:	77 0a                	ja     1f0 <cesar_encode+0x40>
 1e6:	80 f9 40             	cmp    $0x40,%cl
 1e9:	7f 05                	jg     1f0 <cesar_encode+0x40>
        text[i]+=26;
 1eb:	83 c1 1a             	add    $0x1a,%ecx
 1ee:	88 0a                	mov    %cl,(%edx)
    for (int i=0;text[i]!='\0';i++)
 1f0:	0f b6 42 01          	movzbl 0x1(%edx),%eax
 1f4:	83 c2 01             	add    $0x1,%edx
 1f7:	84 c0                	test   %al,%al
 1f9:	75 cd                	jne    1c8 <cesar_encode+0x18>
}
 1fb:	5b                   	pop    %ebx
 1fc:	5e                   	pop    %esi
 1fd:	5f                   	pop    %edi
 ...
 50c:	89 d1                	mov    %edx,%ecx
{
 ...
 539:	0f b6 92 80 09 00 00 	movzbl 0x980(%edx),%edx
 ...
 5b9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5f5:	57                   	push   %edi
 5f6:	56                   	push   %esi
 5f7:	e8 77 fe ff ff       	call   473 <write>
 ...
 629:	ff 24 85 28 09 00 00 	jmp    *0x928(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 64e:	e8 20 fe ff ff       	call   473 <write>
        putc(fd, c);
 ...
 65f:	57                   	push   %edi
 660:	56                   	push   %esi
 661:	e8 0d fe ff ff       	call   473 <write>
        putc(fd, c);
 ...
 6cb:	57                   	push   %edi
 6cc:	56                   	push   %esi
 6cd:	e8 a1 fd ff ff       	call   473 <write>
        while(*s != 0){
 ...
 70c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 70f:	e8 5f fd ff ff       	call   473 <write>
        ap++;
 ...
 737:	90                   	nop
          s = "(null)";
 738:	ba 1e 09 00 00       	mov    $0x91e,%edx
        while(*s != 0){
 ...
 751:	a1 60 0c 00 00       	mov    0xc60,%eax
{
 ...
 791:	5b                   	pop    %ebx
  freep = p;
 792:	89 15 60 0c 00 00    	mov    %edx,0xc60
}
 798:	5e                   	pop    %esi
 799:	5f                   	pop    %edi
 79a:	5d                   	pop    %ebp
 ...
 7c9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 7cc:	89 15 60 0c 00 00    	mov    %edx,0xc60
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7ec:	8b 3d 60 0c 00 00    	mov    0xc60,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 82f:	73 4f                	jae    880 <malloc+0xa0>
    ...
    if(p == freep)
 831:	8b 3d 60 0c 00 00    	mov    0xc60,%edi
 ...
 843:	e8 93 fc ff ff       	call   4db <sbrk>
  if(p == (char*)-1)
 ...
 85a:	e8 f1 fe ff ff       	call   750 <free>
  return freep;
 85f:	8b 15 60 0c 00 00    	mov    0xc60,%edx
