...
00000eb3 <move_file>:
SYSCALL(move_file)
     eb3:	b8 1a 00 00 00       	mov    $0x1a,%eax
     eb8:	cd 40                	int    $0x40
     eba:	c3                   	ret

00000ebb <sort_syscalls>:
SYSCALL(sort_syscalls)
     ebb:	b8 1b 00 00 00       	mov    $0x1b,%eax
     ec0:	cd 40                	int    $0x40
     ec2:	c3                   	ret

00000ec3 <create_palindrom>:
SYSCALL(create_palindrom)
     ec3:	b8 16 00 00 00       	mov    $0x16,%eax
     ec8:	cd 40                	int    $0x40
     eca:	c3                   	ret

00000ecb <get_most_invoked_syscalls>:
SYSCALL(get_most_invoked_syscalls) 
     ecb:	b8 1c 00 00 00       	mov    $0x1c,%eax
     ed0:	cd 40                	int    $0x40
     ed2:	c3                   	ret

00000ed3 <list_all_processes>:
SYSCALL(list_all_processes)
     ed3:	b8 17 00 00 00       	mov    $0x17,%eax
     ed8:	cd 40                	int    $0x40
     eda:	c3                   	ret

00000edb <change_schedular_queue>:
SYSCALL(change_schedular_queue)
     edb:	b8 1e 00 00 00       	mov    $0x1e,%eax
     ee0:	cd 40                	int    $0x40
     ee2:	c3                   	ret

00000ee3 <show_process_info>:
SYSCALL(show_process_info)
     ee3:	b8 1d 00 00 00       	mov    $0x1d,%eax
     ee8:	cd 40                	int    $0x40
     eea:	c3                   	ret

00000eeb <set_proc_sjf_params>:
     eeb:	b8 1f 00 00 00       	mov    $0x1f,%eax
     ef0:	cd 40                	int    $0x40
     ef2:	c3                   	ret
