...
main(void)
{
  ...
  52:	e8 39 04 00 00       	call   490 <printf>
    printf(1, "Team Members:Marziyeh Mousavi, Behrad Binayi, Mehrad livian\n");
  57:	58                   	pop    %eax
  58:	5a                   	pop    %edx
 ...
 3f8:	89 d1                	mov    %edx,%ecx
{
 ...
 42b:	0f b6 92 88 08 00 00 	movzbl 0x888(%edx),%edx
 ...
 499:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 504:	ff 24 85 30 08 00 00 	jmp    *0x830(,%eax,4)
...
free(void *ap)
{
 ...
 621:	a1 30 0b 00 00       	mov    0xb30,%eax
{
 ...
 65f:	5b                   	pop    %ebx
  freep = p;
 660:	a3 30 0b 00 00       	mov    %eax,0xb30
}
 665:	5e                   	pop    %esi
 666:	5f                   	pop    %edi
 667:	5d                   	pop    %ebp
 ...
 676:	72 ce                	jb     646 <free+0x26>
{
 ...
 697:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 69a:	a3 30 0b 00 00       	mov    %eax,0xb30
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 15 30 0b 00 00    	mov    0xb30,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6fb:	3b 05 30 0b 00 00    	cmp    0xb30,%eax
 ...
 71e:	e8 fd fe ff ff       	call   620 <free>
  return freep;
 723:	8b 15 30 0b 00 00    	mov    0xb30,%edx
 ...
 767:	0b 00 00 
    base.s.size = 0;
 76a:	b8 34 0b 00 00       	mov    $0xb34,%eax
    base.s.ptr = freep = prevp = &base;
 76f:	c7 05 34 0b 00 00 34 	movl   $0xb34,0xb34
 776:	0b 00 00 
    base.s.size = 0;
 779:	c7 05 38 0b 00 00 00 	movl   $0x0,0xb38
 780:	00 00 00 
    if(p->s.size >= nunits){
