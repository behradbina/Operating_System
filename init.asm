 ...
 40c:	89 d1                	mov    %edx,%ecx
{
 ...
 439:	0f b6 92 c8 08 00 00 	movzbl 0x8c8(%edx),%edx
 ...
 4b9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 529:	ff 24 85 70 08 00 00 	jmp    *0x870(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 637:	90                   	nop
          s = "(null)";
 638:	ba 66 08 00 00       	mov    $0x866,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 651:	a1 7c 0b 00 00       	mov    0xb7c,%eax
{
 ...
 691:	5b                   	pop    %ebx
  freep = p;
 692:	89 15 7c 0b 00 00    	mov    %edx,0xb7c
}
 698:	5e                   	pop    %esi
 699:	5f                   	pop    %edi
 69a:	5d                   	pop    %ebp
 ...
 6c9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6cc:	89 15 7c 0b 00 00    	mov    %edx,0xb7c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 3d 7c 0b 00 00    	mov    0xb7c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 72f:	73 4f                	jae    780 <malloc+0xa0>
    ...
    if(p == freep)
 731:	8b 3d 7c 0b 00 00    	mov    0xb7c,%edi
 ...
 75a:	e8 f1 fe ff ff       	call   650 <free>
  return freep;
 75f:	8b 15 7c 0b 00 00    	mov    0xb7c,%edx
 ...
 78c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 78f:	89 15 7c 0b 00 00    	mov    %edx,0xb7c
}
 ...
 79f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7a0:	c7 05 7c 0b 00 00 80 	movl   $0xb80,0xb7c
 7a7:	0b 00 00 
    base.s.size = 0;
 7aa:	bf 80 0b 00 00       	mov    $0xb80,%edi
    base.s.ptr = freep = prevp = &base;
 7af:	c7 05 80 0b 00 00 80 	movl   $0xb80,0xb80
 7b6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7b9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7bb:	c7 05 84 0b 00 00 00 	movl   $0x0,0xb84
 7c2:	00 00 00 
    if(p->s.size >= nunits){
