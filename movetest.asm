...
_movetest:     file format elf32-i386
...
int main(int argc, char *argv[]) {
  ...
  34:	e8 1a 03 00 00       	call   353 <move_file>
  39:	83 c4 10             	add    $0x10,%esp
  3c:	85 c0                	test   %eax,%eax
  3e:	74 16                	je     56 <main+0x56>
        printf(1, "File moved successfully.\n");
    } else {
        printf(2, "Error moving file.\n");
  40:	50                   	push   %eax
  41:	50                   	push   %eax
  42:	68 45 07 00 00       	push   $0x745
  47:	6a 02                	push   $0x2
  49:	e8 b2 03 00 00       	call   400 <printf>
 ...
 368:	89 d1                	mov    %edx,%ecx
{
 ...
 39b:	0f b6 92 b8 07 00 00 	movzbl 0x7b8(%edx),%edx
 ...
 409:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 474:	ff 24 85 60 07 00 00 	jmp    *0x760(,%eax,4)
 ...
 580:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 585:	bb 59 07 00 00       	mov    $0x759,%ebx
...
free(void *ap)
{
 ...
 591:	a1 54 0a 00 00       	mov    0xa54,%eax
{
 ...
 5cf:	5b                   	pop    %ebx
  freep = p;
 5d0:	a3 54 0a 00 00       	mov    %eax,0xa54
}
 5d5:	5e                   	pop    %esi
 5d6:	5f                   	pop    %edi
 5d7:	5d                   	pop    %ebp
 ...
 5e6:	72 ce                	jb     5b6 <free+0x26>
{
 ...
 607:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 60a:	a3 54 0a 00 00       	mov    %eax,0xa54
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 629:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 62c:	8b 15 54 0a 00 00    	mov    0xa54,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 66b:	3b 05 54 0a 00 00    	cmp    0xa54,%eax
 ...
 68e:	e8 fd fe ff ff       	call   590 <free>
  return freep;
 693:	8b 15 54 0a 00 00    	mov    0xa54,%edx
 ...
 6bc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6bf:	89 15 54 0a 00 00    	mov    %edx,0xa54
}
 ...
 6cf:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 6d0:	c7 05 54 0a 00 00 58 	movl   $0xa58,0xa54
 6d7:	0a 00 00 
    base.s.size = 0;
 6da:	b8 58 0a 00 00       	mov    $0xa58,%eax
    base.s.ptr = freep = prevp = &base;
 6df:	c7 05 58 0a 00 00 58 	movl   $0xa58,0xa58
 6e6:	0a 00 00 
    base.s.size = 0;
 6e9:	c7 05 5c 0a 00 00 00 	movl   $0x0,0xa5c
 6f0:	00 00 00 
    if(p->s.size >= nunits){
