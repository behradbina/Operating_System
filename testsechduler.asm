...
_testsechduler:     file format elf32-i386
...
int main(int argc, char *argv[]) {
  17:	8b 59 04             	mov    0x4(%ecx),%ebx
    int durations[] = {20, 40, 60, 80, 100}; // Different durations for each process
  1a:	c7 45 d4 14 00 00 00 	movl   $0x14,-0x2c(%ebp)
  21:	c7 45 d8 28 00 00 00 	movl   $0x28,-0x28(%ebp)
  28:	c7 45 dc 3c 00 00 00 	movl   $0x3c,-0x24(%ebp)
  2f:	c7 45 e0 50 00 00 00 	movl   $0x50,-0x20(%ebp)
  36:	c7 45 e4 64 00 00 00 	movl   $0x64,-0x1c(%ebp)
    if (argc < 3) {
  3d:	7f 13                	jg     52 <main+0x52>
  ...
  63:	89 c7                	mov    %eax,%edi
    int confidence=atoi(argv[2]);
  65:	e8 86 02 00 00       	call   2f0 <atoi>
  6a:	83 c4 10             	add    $0x10,%esp
  6d:	89 45 c4             	mov    %eax,-0x3c(%ebp)
        pid = fork();
  70:	e8 e6 02 00 00       	call   35b <fork>
        //sort_syscall(pid);
        set_proc_sjf_params(pid,bursttime,confidence);
  75:	83 ec 04             	sub    $0x4,%esp
  78:	ff 75 c4             	push   -0x3c(%ebp)
  7b:	57                   	push   %edi
        pid = fork();
  7c:	89 c3                	mov    %eax,%ebx
        set_proc_sjf_params(pid,bursttime,confidence);
  7e:	50                   	push   %eax
  7f:	e8 b7 03 00 00       	call   43b <set_proc_sjf_params>
        if (pid == 0) {
  84:	83 c4 10             	add    $0x10,%esp
  87:	85 db                	test   %ebx,%ebx
  89:	74 36                	je     c1 <main+0xc1>
  ...
  8b:	78 5a                	js     e7 <main+0xe7>
    for (int i = 0; i < num_processes; i++) {
  8d:	83 c6 01             	add    $0x1,%esi
  90:	83 fe 05             	cmp    $0x5,%esi
  93:	75 db                	jne    70 <main+0x70>
    ...
    for (int i = 0; i < num_processes; i++) {
        wait();
  95:	e8 d1 02 00 00       	call   36b <wait>
  9a:	e8 cc 02 00 00       	call   36b <wait>
  9f:	e8 c7 02 00 00       	call   36b <wait>
  a4:	e8 c2 02 00 00       	call   36b <wait>
  a9:	e8 bd 02 00 00       	call   36b <wait>
    }

    printf(1, "All processes completed\n");
  ae:	50                   	push   %eax
  af:	50                   	push   %eax
  b0:	68 4a 08 00 00       	push   $0x84a
  b5:	6a 01                	push   $0x1
  b7:	e8 34 04 00 00       	call   4f0 <printf>
    exit();
  bc:	e8 a2 02 00 00       	call   363 <exit>
            do_work(durations[i]);
  c1:	83 ec 0c             	sub    $0xc,%esp
  c4:	ff 74 b5 d4          	push   -0x2c(%ebp,%esi,4)
  c8:	e8 33 00 00 00       	call   100 <do_work>
            printf(1, "Process %d finished\n", getpid());
  cd:	e8 11 03 00 00       	call   3e3 <getpid>
  d2:	83 c4 0c             	add    $0xc,%esp
  d5:	50                   	push   %eax
  d6:	68 28 08 00 00       	push   $0x828
  db:	6a 01                	push   $0x1
  dd:	e8 0e 04 00 00       	call   4f0 <printf>
            exit();
  e2:	e8 7c 02 00 00       	call   363 <exit>
            printf(1, "Fork failed\n");
  e7:	52                   	push   %edx
  e8:	52                   	push   %edx
  e9:	68 3d 08 00 00       	push   $0x83d
  ee:	6a 01                	push   $0x1
  f0:	e8 fb 03 00 00       	call   4f0 <printf>
            exit();
  f5:	e8 69 02 00 00       	call   363 <exit>
  fa:	66 90                	xchg   %ax,%ax
  fc:	66 90                	xchg   %ax,%ax
  fe:	66 90                	xchg   %ax,%ax
...
void do_work(int duration) {
 ...
 108:	e8 ee 02 00 00       	call   3fb <uptime>
 10d:	89 c3                	mov    %eax,%ebx
    while (uptime() - start < duration) {
 10f:	90                   	nop
 110:	e8 e6 02 00 00       	call   3fb <uptime>
 115:	29 d8                	sub    %ebx,%eax
 117:	39 f0                	cmp    %esi,%eax
 119:	7c f5                	jl     110 <do_work+0x10>
}
 11b:	5b                   	pop    %ebx
 11c:	5e                   	pop    %esi
 11d:	5d                   	pop    %ebp
 ...
 458:	89 d1                	mov    %edx,%ecx
{
 ...
 48b:	0f b6 92 c4 08 00 00 	movzbl 0x8c4(%edx),%edx
 ...
 4f9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 564:	ff 24 85 6c 08 00 00 	jmp    *0x86c(,%eax,4)
 ...
 670:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 675:	bb 63 08 00 00       	mov    $0x863,%ebx
 ...
 681:	a1 94 0b 00 00       	mov    0xb94,%eax
{
 ...
 6bf:	5b                   	pop    %ebx
  freep = p;
 6c0:	a3 94 0b 00 00       	mov    %eax,0xb94
}
 6c5:	5e                   	pop    %esi
 6c6:	5f                   	pop    %edi
 6c7:	5d                   	pop    %ebp
 ...
 6d6:	72 ce                	jb     6a6 <free+0x26>
{
 ...
 6f7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6fa:	a3 94 0b 00 00       	mov    %eax,0xb94
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 719:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 71c:	8b 15 94 0b 00 00    	mov    0xb94,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 75b:	3b 05 94 0b 00 00    	cmp    0xb94,%eax
 ...
 77e:	e8 fd fe ff ff       	call   680 <free>
  return freep;
 783:	8b 15 94 0b 00 00    	mov    0xb94,%edx
 ...
 7ac:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7af:	89 15 94 0b 00 00    	mov    %edx,0xb94
}
 ...
 7bf:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 7c0:	c7 05 94 0b 00 00 98 	movl   $0xb98,0xb94
 7c7:	0b 00 00 
    base.s.size = 0;
 7ca:	b8 98 0b 00 00       	mov    $0xb98,%eax
    base.s.ptr = freep = prevp = &base;
 7cf:	c7 05 98 0b 00 00 98 	movl   $0xb98,0xb98
 7d6:	0b 00 00 
    base.s.size = 0;
 7d9:	c7 05 9c 0b 00 00 00 	movl   $0x0,0xb9c
 7e0:	00 00 00 
    if(p->s.size >= nunits){
