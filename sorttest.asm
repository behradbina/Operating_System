...
int main(int argc, char *argv[]) {
  ...
  25:	89 c3                	mov    %eax,%ebx
    if (sort_syscalls(pid) < 0) {
  27:	e8 2f 03 00 00       	call   35b <sort_syscalls>
  ...
  5c:	51                   	push   %ecx
  5d:	51                   	push   %ecx
  5e:	68 48 07 00 00       	push   $0x748
  63:	6a 01                	push   $0x1
  65:	e8 d6 03 00 00       	call   440 <printf>
        exit();
  6a:	e8 44 02 00 00       	call   2b3 <exit>
  6f:	90                   	nop
 ...
 3a8:	89 d1                	mov    %edx,%ecx
{
 ...
 3db:	0f b6 92 1c 08 00 00 	movzbl 0x81c(%edx),%edx
 ...
 449:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4b4:	ff 24 85 c4 07 00 00 	jmp    *0x7c4(,%eax,4)
 ...
 5c0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5c5:	bb bd 07 00 00       	mov    $0x7bd,%ebx
...
free(void *ap)
{
 ...
 5d1:	a1 bc 0a 00 00       	mov    0xabc,%eax
{
 ...
 60f:	5b                   	pop    %ebx
  freep = p;
 610:	a3 bc 0a 00 00       	mov    %eax,0xabc
}
 615:	5e                   	pop    %esi
 616:	5f                   	pop    %edi
 617:	5d                   	pop    %ebp
 ...
 626:	72 ce                	jb     5f6 <free+0x26>
{
 ...
 647:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 64a:	a3 bc 0a 00 00       	mov    %eax,0xabc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 15 bc 0a 00 00    	mov    0xabc,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ab:	3b 05 bc 0a 00 00    	cmp    0xabc,%eax
 ...
 6ce:	e8 fd fe ff ff       	call   5d0 <free>
  return freep;
 6d3:	8b 15 bc 0a 00 00    	mov    0xabc,%edx
 ...
 6fc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6ff:	89 15 bc 0a 00 00    	mov    %edx,0xabc
}
 ...
 70f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 710:	c7 05 bc 0a 00 00 c0 	movl   $0xac0,0xabc
 717:	0a 00 00 
    base.s.size = 0;
 71a:	b8 c0 0a 00 00       	mov    $0xac0,%eax
    base.s.ptr = freep = prevp = &base;
 71f:	c7 05 c0 0a 00 00 c0 	movl   $0xac0,0xac0
 726:	0a 00 00 
    base.s.size = 0;
 729:	c7 05 c4 0a 00 00 00 	movl   $0x0,0xac4
 730:	00 00 00 
    if(p->s.size >= nunits){
