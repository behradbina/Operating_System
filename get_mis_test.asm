...
int main(int argc, char *argv[]) {
  ...
  25:	89 c3                	mov    %eax,%ebx
    if (get_most_invoked_syscalls(pid) <0) {
  27:	e8 2f 03 00 00       	call   35b <get_most_invoked_syscalls>
 ...
 439:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5b0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5b5:	bb 53 07 00 00       	mov    $0x753,%ebx
 ...
 5c1:	a1 8c 0a 00 00       	mov    0xa8c,%eax
{
 ...
 5ff:	5b                   	pop    %ebx
  freep = p;
 600:	a3 8c 0a 00 00       	mov    %eax,0xa8c
}
 605:	5e                   	pop    %esi
 606:	5f                   	pop    %edi
 607:	5d                   	pop    %ebp
 ...
 616:	72 ce                	jb     5e6 <free+0x26>
{
 ...
 637:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 63a:	a3 8c 0a 00 00       	mov    %eax,0xa8c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 15 8c 0a 00 00    	mov    0xa8c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 69b:	3b 05 8c 0a 00 00    	cmp    0xa8c,%eax
 ...
 6be:	e8 fd fe ff ff       	call   5c0 <free>
  return freep;
 6c3:	8b 15 8c 0a 00 00    	mov    0xa8c,%edx
 ...
 707:	0a 00 00 
    base.s.size = 0;
 70a:	b8 90 0a 00 00       	mov    $0xa90,%eax
    base.s.ptr = freep = prevp = &base;
 70f:	c7 05 90 0a 00 00 90 	movl   $0xa90,0xa90
 716:	0a 00 00 
    base.s.size = 0;
 719:	c7 05 94 0a 00 00 00 	movl   $0x0,0xa94
 720:	00 00 00 
    if(p->s.size >= nunits){
