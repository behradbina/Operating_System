...
int main(int argc, char *argv[]) {
  ...
  25:	89 c3                	mov    %eax,%ebx
    if (get_most_invoked_syscalls(pid) <0) {
  27:	e8 37 03 00 00       	call   363 <get_most_invoked_syscalls>
...
00000363 <get_most_invoked_syscalls>:
 ...
 37c:	89 d1                	mov    %edx,%ecx
{
 ...
 3a9:	0f b6 92 fc 07 00 00 	movzbl 0x7fc(%edx),%edx
 ...
 429:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 499:	ff 24 85 a4 07 00 00 	jmp    *0x7a4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5a7:	90                   	nop
          s = "(null)";
 5a8:	ba 9a 07 00 00       	mov    $0x79a,%edx
        while(*s != 0){
