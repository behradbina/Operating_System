...
_get_mis_test:     file format elf32-i386
...
int main(int argc, char *argv[]) {
  ...
  25:	89 c3                	mov    %eax,%ebx
    if (get_most_invoked_syscalls(pid) <0) {
  27:	e8 3f 03 00 00       	call   36b <get_most_invoked_syscalls>
  ...
  31:	78 18                	js     4b <main+0x4b>
    ...
    exit();
  33:	e8 7b 02 00 00       	call   2b3 <exit>
        printf(1, "Usage: get_mis_test <pid>\n");
  38:	52                   	push   %edx
  39:	52                   	push   %edx
  3a:	68 58 07 00 00       	push   $0x758
  3f:	6a 01                	push   $0x1
 ...
 38c:	89 d1                	mov    %edx,%ecx
{
 ...
 3b9:	0f b6 92 0c 08 00 00 	movzbl 0x80c(%edx),%edx
 ...
 439:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4a9:	ff 24 85 b4 07 00 00 	jmp    *0x7b4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5b7:	90                   	nop
          s = "(null)";
 5b8:	ba aa 07 00 00       	mov    $0x7aa,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5d1:	a1 b8 0a 00 00       	mov    0xab8,%eax
{
 ...
 611:	5b                   	pop    %ebx
  freep = p;
 612:	89 15 b8 0a 00 00    	mov    %edx,0xab8
}
 618:	5e                   	pop    %esi
 619:	5f                   	pop    %edi
 61a:	5d                   	pop    %ebp
 ...
 649:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 64c:	89 15 b8 0a 00 00    	mov    %edx,0xab8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 3d b8 0a 00 00    	mov    0xab8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	73 4f                	jae    700 <malloc+0xa0>
    ...
    if(p == freep)
 6b1:	8b 3d b8 0a 00 00    	mov    0xab8,%edi
 ...
 6da:	e8 f1 fe ff ff       	call   5d0 <free>
  return freep;
 6df:	8b 15 b8 0a 00 00    	mov    0xab8,%edx
 ...
 70c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 70f:	89 15 b8 0a 00 00    	mov    %edx,0xab8
}
 ...
 71f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 720:	c7 05 b8 0a 00 00 bc 	movl   $0xabc,0xab8
 727:	0a 00 00 
    base.s.size = 0;
 72a:	bf bc 0a 00 00       	mov    $0xabc,%edi
    base.s.ptr = freep = prevp = &base;
 72f:	c7 05 bc 0a 00 00 bc 	movl   $0xabc,0xabc
 736:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 739:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 73b:	c7 05 c0 0a 00 00 00 	movl   $0x0,0xac0
 742:	00 00 00 
    if(p->s.size >= nunits){
