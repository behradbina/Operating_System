...
_sorttest:     file format elf32-i386
...
int main(int argc, char *argv[]) {
  ...
  25:	89 c3                	mov    %eax,%ebx
    if (sort_syscalls(pid) < 0) {
  27:	e8 3f 03 00 00       	call   36b <sort_syscalls>
  2c:	83 c4 10             	add    $0x10,%esp
  2f:	85 c0                	test   %eax,%eax
  31:	78 16                	js     49 <main+0x49>
  ...
  41:	83 c4 10             	add    $0x10,%esp
    ...
    exit();
  44:	e8 7a 02 00 00       	call   2c3 <exit>
        printf(1, "Error: Could not sort syscalls for pid %d\n", pid);
  49:	52                   	push   %edx
  4a:	53                   	push   %ebx
  ...
  65:	e8 d6 03 00 00       	call   440 <printf>
        exit();
  6a:	e8 54 02 00 00       	call   2c3 <exit>
  6f:	90                   	nop
 ...
 39c:	89 d1                	mov    %edx,%ecx
{
 ...
 3c9:	0f b6 92 3c 08 00 00 	movzbl 0x83c(%edx),%edx
 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4b9:	ff 24 85 e4 07 00 00 	jmp    *0x7e4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5c7:	90                   	nop
          s = "(null)";
 5c8:	ba dd 07 00 00       	mov    $0x7dd,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5e1:	a1 e8 0a 00 00       	mov    0xae8,%eax
{
 ...
 621:	5b                   	pop    %ebx
  freep = p;
 622:	89 15 e8 0a 00 00    	mov    %edx,0xae8
}
 628:	5e                   	pop    %esi
 629:	5f                   	pop    %edi
 62a:	5d                   	pop    %ebp
 ...
 659:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 65c:	89 15 e8 0a 00 00    	mov    %edx,0xae8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 3d e8 0a 00 00    	mov    0xae8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6bf:	73 4f                	jae    710 <malloc+0xa0>
    ...
    if(p == freep)
 6c1:	8b 3d e8 0a 00 00    	mov    0xae8,%edi
 ...
 6ea:	e8 f1 fe ff ff       	call   5e0 <free>
  return freep;
 6ef:	8b 15 e8 0a 00 00    	mov    0xae8,%edx
 ...
 71c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 71f:	89 15 e8 0a 00 00    	mov    %edx,0xae8
}
 ...
 72f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 730:	c7 05 e8 0a 00 00 ec 	movl   $0xaec,0xae8
 737:	0a 00 00 
    base.s.size = 0;
 73a:	bf ec 0a 00 00       	mov    $0xaec,%edi
    base.s.ptr = freep = prevp = &base;
 73f:	c7 05 ec 0a 00 00 ec 	movl   $0xaec,0xaec
 746:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 749:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 74b:	c7 05 f0 0a 00 00 00 	movl   $0x0,0xaf0
 752:	00 00 00 
    if(p->s.size >= nunits){
