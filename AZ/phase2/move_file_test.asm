...
_move_file_test:     file format elf32-i386
 ...
 39c:	89 d1                	mov    %edx,%ecx
{
 ...
 3c9:	0f b6 92 18 08 00 00 	movzbl 0x818(%edx),%edx
 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4b9:	ff 24 85 c0 07 00 00 	jmp    *0x7c0(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5c7:	90                   	nop
          s = "(null)";
 5c8:	ba b9 07 00 00       	mov    $0x7b9,%edx
        while(*s != 0){
 ...
 5e1:	a1 c0 0a 00 00       	mov    0xac0,%eax
{
 ...
 621:	5b                   	pop    %ebx
  freep = p;
 622:	89 15 c0 0a 00 00    	mov    %edx,0xac0
}
 628:	5e                   	pop    %esi
 629:	5f                   	pop    %edi
 62a:	5d                   	pop    %ebp
 ...
 659:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 65c:	89 15 c0 0a 00 00    	mov    %edx,0xac0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 3d c0 0a 00 00    	mov    0xac0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6bf:	73 4f                	jae    710 <malloc+0xa0>
    ...
    if(p == freep)
 6c1:	8b 3d c0 0a 00 00    	mov    0xac0,%edi
 ...
 6ea:	e8 f1 fe ff ff       	call   5e0 <free>
  return freep;
 6ef:	8b 15 c0 0a 00 00    	mov    0xac0,%edx
 ...
 737:	0a 00 00 
    base.s.size = 0;
 73a:	bf c4 0a 00 00       	mov    $0xac4,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 749:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 74b:	c7 05 c8 0a 00 00 00 	movl   $0x0,0xac8
 752:	00 00 00 
    if(p->s.size >= nunits){
