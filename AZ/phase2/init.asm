...
main(void)
{
  ...
  ac:	50                   	push   %eax
  ad:	50                   	push   %eax
  ae:	68 84 0b 00 00       	push   $0xb84
  b3:	68 16 08 00 00       	push   $0x816
  b8:	e8 ce 02 00 00       	call   38b <exec>
      printf(1, "init: exec sh failed\n");
  bd:	5a                   	pop    %edx
  be:	59                   	pop    %ecx
  bf:	68 19 08 00 00       	push   $0x819
  c4:	6a 01                	push   $0x1
  ...
  d1:	6a 01                	push   $0x1
  d3:	6a 01                	push   $0x1
  d5:	68 e8 07 00 00       	push   $0x7e8
  da:	e8 bc 02 00 00       	call   39b <mknod>
    open("console", O_RDWR);
  df:	5b                   	pop    %ebx
  e0:	58                   	pop    %eax
  e1:	6a 02                	push   $0x2
  e3:	68 e8 07 00 00       	push   $0x7e8
...
00000403 <get_most_invoked_syscalls>:
 ...
 41c:	89 d1                	mov    %edx,%ecx
{
 ...
 449:	0f b6 92 d8 08 00 00 	movzbl 0x8d8(%edx),%edx
 ...
 4c9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 539:	ff 24 85 80 08 00 00 	jmp    *0x880(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 647:	90                   	nop
          s = "(null)";
 648:	ba 76 08 00 00       	mov    $0x876,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 661:	a1 8c 0b 00 00       	mov    0xb8c,%eax
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	89 15 8c 0b 00 00    	mov    %edx,0xb8c
}
 6a8:	5e                   	pop    %esi
 6a9:	5f                   	pop    %edi
 6aa:	5d                   	pop    %ebp
 ...
 6d9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6dc:	89 15 8c 0b 00 00    	mov    %edx,0xb8c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 3d 8c 0b 00 00    	mov    0xb8c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 73f:	73 4f                	jae    790 <malloc+0xa0>
    ...
    if(p == freep)
 741:	8b 3d 8c 0b 00 00    	mov    0xb8c,%edi
 ...
 76a:	e8 f1 fe ff ff       	call   660 <free>
  return freep;
 76f:	8b 15 8c 0b 00 00    	mov    0xb8c,%edx
 ...
 79c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 79f:	89 15 8c 0b 00 00    	mov    %edx,0xb8c
}
