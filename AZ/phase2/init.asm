...
00000403 <create_palindrom>:
SYSCALL(create_palindrom)
 403:	b8 16 00 00 00       	mov    $0x16,%eax
 408:	cd 40                	int    $0x40
 40a:	c3                   	ret    

0000040b <get_most_invoked_syscalls>:
 ...
 42c:	89 d1                	mov    %edx,%ecx
{
 ...
 459:	0f b6 92 e8 08 00 00 	movzbl 0x8e8(%edx),%edx
 ...
 4d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 549:	ff 24 85 90 08 00 00 	jmp    *0x890(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 657:	90                   	nop
          s = "(null)";
 658:	ba 86 08 00 00       	mov    $0x886,%edx
        while(*s != 0){
 ...
 671:	a1 9c 0b 00 00       	mov    0xb9c,%eax
{
 ...
 6b1:	5b                   	pop    %ebx
  freep = p;
 6b2:	89 15 9c 0b 00 00    	mov    %edx,0xb9c
}
 6b8:	5e                   	pop    %esi
 6b9:	5f                   	pop    %edi
 6ba:	5d                   	pop    %ebp
 ...
 6e9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ec:	89 15 9c 0b 00 00    	mov    %edx,0xb9c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 3d 9c 0b 00 00    	mov    0xb9c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 74f:	73 4f                	jae    7a0 <malloc+0xa0>
    ...
    if(p == freep)
 751:	8b 3d 9c 0b 00 00    	mov    0xb9c,%edi
 ...
 77a:	e8 f1 fe ff ff       	call   670 <free>
  return freep;
 77f:	8b 15 9c 0b 00 00    	mov    0xb9c,%edx
 ...
 7ac:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7af:	89 15 9c 0b 00 00    	mov    %edx,0xb9c
}
 ...
 7bf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7c0:	c7 05 9c 0b 00 00 a0 	movl   $0xba0,0xb9c
 7c7:	0b 00 00 
    base.s.size = 0;
 7ca:	bf a0 0b 00 00       	mov    $0xba0,%edi
    base.s.ptr = freep = prevp = &base;
 7cf:	c7 05 a0 0b 00 00 a0 	movl   $0xba0,0xba0
 7d6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7d9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7db:	c7 05 a4 0b 00 00 00 	movl   $0x0,0xba4
 7e2:	00 00 00 
    if(p->s.size >= nunits){
