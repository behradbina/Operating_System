...
int main(int argc, char *argv[]) {
  ...
  2a:	51                   	push   %ecx
  2b:	51                   	push   %ecx
  2c:	68 97 07 00 00       	push   $0x797
  31:	6a 02                	push   $0x2
  33:	e8 18 04 00 00       	call   450 <printf>
    int num = atoi(argv[1]);
  38:	58                   	pop    %eax
  39:	ff 73 04             	push   0x4(%ebx)
  ...
  48:	e8 36 03 00 00       	call   383 <create_palindrom>
  4d:	83 c4 10             	add    $0x10,%esp
  50:	85 c0                	test   %eax,%eax
  52:	74 16                	je     6a <main+0x6a>
        printf(1, "successfully.\n");
    } else {
        printf(2, "Error.\n");
  54:	50                   	push   %eax
  55:	50                   	push   %eax
  56:	68 c3 07 00 00       	push   $0x7c3
  5b:	6a 02                	push   $0x2
 ...
 3ac:	89 d1                	mov    %edx,%ecx
{
 ...
 3d9:	0f b6 92 2c 08 00 00 	movzbl 0x82c(%edx),%edx
 ...
 459:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4c9:	ff 24 85 d4 07 00 00 	jmp    *0x7d4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5d7:	90                   	nop
          s = "(null)";
 5d8:	ba cb 07 00 00       	mov    $0x7cb,%edx
        while(*s != 0){
 ...
 5f1:	a1 d8 0a 00 00       	mov    0xad8,%eax
{
 ...
 631:	5b                   	pop    %ebx
  freep = p;
 632:	89 15 d8 0a 00 00    	mov    %edx,0xad8
}
 638:	5e                   	pop    %esi
 639:	5f                   	pop    %edi
 63a:	5d                   	pop    %ebp
 ...
 669:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 66c:	89 15 d8 0a 00 00    	mov    %edx,0xad8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 3d d8 0a 00 00    	mov    0xad8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cf:	73 4f                	jae    720 <malloc+0xa0>
    ...
    if(p == freep)
 6d1:	8b 3d d8 0a 00 00    	mov    0xad8,%edi
 ...
 6fa:	e8 f1 fe ff ff       	call   5f0 <free>
  return freep;
 6ff:	8b 15 d8 0a 00 00    	mov    0xad8,%edx
 ...
 73f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 740:	c7 05 d8 0a 00 00 dc 	movl   $0xadc,0xad8
 747:	0a 00 00 
    base.s.size = 0;
 74a:	bf dc 0a 00 00       	mov    $0xadc,%edi
    base.s.ptr = freep = prevp = &base;
 74f:	c7 05 dc 0a 00 00 dc 	movl   $0xadc,0xadc
 756:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 759:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 75b:	c7 05 e0 0a 00 00 00 	movl   $0x0,0xae0
 762:	00 00 00 
    if(p->s.size >= nunits){
