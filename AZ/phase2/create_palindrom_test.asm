...
int main(int argc, char *argv[]) {
  ...
  55:	e8 39 03 00 00       	call   393 <create_palindrom>
 ...
 469:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4d9:	ff 24 85 e4 07 00 00 	jmp    *0x7e4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5e7:	90                   	nop
          s = "(null)";
 5e8:	ba db 07 00 00       	mov    $0x7db,%edx
        while(*s != 0){
